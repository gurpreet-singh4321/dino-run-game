...
def process_space_panorama():
    ...
    p1_path = os.path.join(base_dir, "flat_orbit_1_clean_1788284575898.jpg")
    p2_path = os.path.join(base_dir, "flat_orbit_2_1788284533857.jpg")
    p3_path = os.path.join(base_dir, "flat_orbit_3_1788284552824.jpg")
    ...
    seamless_space = make_truly_seamless(stitched_123, wrap_overlap=280)
    print(f"Final seamless continuous Earth orbit panorama shape: {seamless_space.shape}")
    ...
    print(f"Saved continuous Earth orbit Space Mode background to: {out_path}")
